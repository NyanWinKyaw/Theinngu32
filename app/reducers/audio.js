...
var initialState = {isLoading:false, isLoadingDB: false, isEmpty: false, searchString: '', files:ds.cloneWithRows([]), favourites:ds.cloneWithRows([])};


export default function audioFile(state = initialState, action = {}){
  ...
  switch (action.type) {
    ...
    case types.RECEIVE_ADDRESS:
      return Object.assign({},state, { isEmpty: false, isLoading:false, files: ds.cloneWithRows(action.addresses)});
